...
if __name__ == "__main__":
    ...
    if prepare_data:
        ...
        prepare_data_command = "python ./scripts/prepare_data.py --train_cal_raw_path {} --test_raw_path {} " \
                               .format(train_cal_raw_path, test_raw_path)
        os.system(prepare_data_command)
    commands = generate_commands_discrimination(exp_dir, Z, n_trains, n_cals, n_test, lbds, runs, n_runs_test, k, classifier_type,
