...
Z_labels = {
    ...
    4: {0: "With a disability", 1: "Without a disability", "feature": "Disability record (Z)", "num_groups": 2,
        "color": "orchid", "marker": "v"},
    6: {0: "Born in the US", 1: "Born in Unincorporated US", 2: "Born abroad", 3: "Not a US citizen",
        "feature": "Citizenship status (Z)", "num_groups": 4, "color": "deepskyblue", "marker": "D"},
    ...
    15: {0: "White", 1: "Black or African American", 2: "American Indian or Alaska",
         3: "Asian, Native Hawaiian or other", "feature": "Race code (Z)", "num_groups": 4, "color": "lightcoral",
         "marker": "h"},
    1: {0: "No diploma", 1: "diploma", 2: "Associate or Bachelor degree", 3: "Masters or Doctorate degree",
        "feature": "Educational attainment (Z)", "num_groups": 4},
    0: {0: "0-25", 1: "26-50", 2: "51-75", 3: "76-99", "feature": "Age (Z)", "num_groups": 4, "color": "seagreen",
        "marker": "^"}
}
algorithm_labels = {}
algorithm_colors = {}
algorithm_markers = {}
metric_labels = {"group_accuracy": r'$\Pr(Y=\hat{Y}|Z)$', "n_bins": r'$|\mathcal{B}|$',
                 "accuracy": r'$\Pr(\hat{Y} = Y)$', "num_selected": r'Shortlist Size', \
                 "alpha": r'$\epsilon$', "tpr": "True Positive Rate", "group_tpr": "True Positive Rate",
                 "log_loss": "Cross Entropy Loss" \
    , "prob_pred": r"$\Pr(\hat{Y}=1|X)$", "ECE": "ECE", "sharpness": "Sharpness Score", "f1_score": "F1 Score",
                 "group_num_in_bin": "Discrimination prob", "pool_discriminated": "Pool Discrimination prob"}
xlabels = {"n_bins": r'$n$', "fpr": "False Positive Rate", "group_fpr": "False Positive Rate", \
