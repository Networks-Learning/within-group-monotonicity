...
n_cals =[10000, 50000]# [10000, 50000, 100000, 500000,1000000]#, 2000, 5000, 10000, 20000, 50000, 100000]
n_cals_label = ["1e4", "5e5"]#["1e4", "5e4", "1e5", "5e5", "1e6"]
runs = list(range(n_runs))
classifier_type = "LR"
lbd = "1e-6"
lbds = ["1e-6"]
umb_num_bins = [10,15]#[5,10,15,20,25,30]#, 2, 3, 4, 5]
umb_colors = {5: "tab:orange", 10: "tab:brown", 15: "tab:pink", 20: "tab:gray", 25: "tab:olive", 30:"tab:blue"}
# wgm_colors = {5: "tab:blue", 10: "tab:red", 15: "tab:purple", 20: "tab:cyan", 25: "tab:orange", 30:"tab:blue"}
